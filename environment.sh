...
export LDFLAGS="-ios_version_min $IPHONEOS_MIN_VERSION -arch $ARCH -L$SDKROOT/usr/lib -F$SDKROOT/System/Library/Frameworks -L$SDKROOT/usr/lib/system -e _main -syslibroot $SDKROOT"
